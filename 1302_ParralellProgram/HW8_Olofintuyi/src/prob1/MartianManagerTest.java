...
public class MartianManagerTest {
	public static void main(String[] args) {
		...
		testGetSortedMartiansById();
		testGetSortedMartiansByVolume();
		testGetTeleprterAt();
	...
	public static void testGetSortedMartiansById() {
		System.out.println("\n-->testGetSortedMartiansById");
		MartianManager m = createMartianManagerWith6Martians();
		System.out.println("expected");
		System.out.println(
		...
		System.out.println("actual");
		System.out.println(m.getSortedMartiansSpring2020("Id"));

	}
	
	public static void testGetSortedMartiansByVolume() {
		System.out.println("\n-->testGetSortedMartiansById");
		MartianManager m = createMartianManagerWith6Martians();
		System.out.println("expected");
		System.out.println(
				"[Green Martian - id=10, vol=50, Red Martian - id=15, vol=1, ten=10, Red Martian - id=25, vol=1, ten=52, Green Martian - id=30, vol=15, Red Martian - id=35, vol=1, ten=600, Green Martian - id=55, vol=700]");
		System.out.println("actual");
		System.out.println(m.getSortedMartiansSpring2020("Volume"));
	...
	public static void testGetTeleprterAt() {
		...
		System.out.println("actual");
		System.out.println(m.getTeleporterAt(30));
	}
	...
	public static void testGetTeleprterAt_Fail() {
		...
		System.out.println("actual");
		System.out.println(m.getTeleporterAt(3));
	}
